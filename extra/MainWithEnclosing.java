...
public class MainWithEnclosing {
    ...
    private static final Map<String, Integer> fieldsAll = new HashMap<>();
    private static final Map<String, Integer> methodsDeclared = new HashMap<>();
    private static final Map<String, Integer> methodsAll = new HashMap<>();
    private static final Map<String, Integer> subtypesTotal = new HashMap<>();
    private static final Map<String, Integer> supertypesTotal = new HashMap<>();
